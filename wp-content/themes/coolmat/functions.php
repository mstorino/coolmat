...
function coolmat_scripts() {
	...
	//here we load custom.css file using wp_enqueue_style
...
// here we create custom intro post type
...
// Here we add location post type
...
// custom category description function
